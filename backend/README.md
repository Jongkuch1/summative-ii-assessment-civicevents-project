...
| ---- | ----------- | ------------- |
| **Node.js (v18+)** | JavaScript runtime for the backend | [nodejs.org](https://nodejs.org/) |
| **PostgreSQL (v15+)** | Database engine | [postgresql.org](https://www.postgresql.org/download/) |
| **pgAdmin (optional)** | GUI client for PostgreSQL | [pgadmin.org](https://www.pgadmin.org/download/) |
| **Postman** | API testing tool | [postman.com](https://www.postman.com/downloads/) |
...
- Create the Database — after installing PostgreSQL, create the project database:
  `CREATE DATABASE civic-events-db;`
  You can run this in the PostgreSQL terminal (psql) or in pgAdmin.
...
- Install Postman from [postman.com/downloads](https://www.postman.com/downloads/).
...
- Configure the environment variables: change the values in the `.env` file with the appropriate database credentials.
